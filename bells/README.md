...
Access [localhost:8000/bells/admin/](http://localhost:8000/bells/admin/).

## Configuration / Environment Variables

<!-- [[[cog
import cog
from bells.config import Config
...
* **DEBUG**
  ...
  * default: `False`
* **ALLOWED_HOSTS**
  * description: Hosts allowed to serve the site https://docs.djangoproject.com/en/5.0/ref/settings/#allowed-hosts
  * type: `list[str]`
  * default: `['*']`
* **DATABASE_URL**
...
* **SECRET_KEY** _REQUIRED_
  * description: A long random string you keep secret https://docs.djangoproject.com/en/5.0/ref/settings/#secret-key
  * type: `str`
* **ENVIRONMENT**
